...
public class Exerc05 {
    ...
    public static void criarLog() {
        ...
        String nomeArquivo = String.format("%s_mergesort.txt.txt", matricula);
    ...
    public static void main(String[] args) {
        ...
        mergesort(musicas, 0, musicas.length - 1);
    ...
    // Mergesort
    public static void mergesort(Musica[] musica, int esq, int dir) {
        if (esq < dir) {
            int meio = (esq + dir) / 2;
            mergesort(musica, esq, meio);
            mergesort(musica, meio + 1, dir);
            intercalar(musica, esq, meio, dir);
        }
    }

    private static void intercalar(Musica[] musica, int esq, int meio, int dir) {
        ...
        Musica[] a1 = new Musica[n1];
        Musica[] a2 = new Musica[n2];
