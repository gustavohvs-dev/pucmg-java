...
public class Exerc07 {
    ...
    public static void criarLog() {
        ...
        String nomeArquivo = String.format("%s_bolha.txt", matricula);
    ...
    public static void sort(Musica[] musica) {
        ...
        for (int i = (n - 1); i > 0; i--) {
            for (int j = 0; j < i; j++) {
                if (musica[j].getDanceability() > musica[j+1].getDanceability()){
                    Musica temp = musica[j];
                    musica[j] = musica[j+1];
                    musica[j+1] = temp;
                }else if(musica[j].getDanceability() == musica[j+1].getDanceability() && musica[j+1].getName().compareTo(musica[j].getName()) < 0){
                    Musica temp = musica[j];
                    musica[j] = musica[j+1];
                    musica[j+1] = temp;
                }else{
