...
public class Exerc02 {
	...
	public static void main(String[] args) {
		...
		id = MyIO.readLine();
		while (!id.equals("FIM")){
			if(pesquisaBinariaRecursiva(vetorMusicas, id)){
	...
	public static boolean pesquisaBinariaRecursiva(Musica[] musicas, String x) {
		return pesquisaBinariaRecursiva(musicas, x, 0, (musicas.length - 1));
	}

	public static boolean pesquisaBinariaRecursiva(Musica[] musicas, String x, int esq, int dir) {
